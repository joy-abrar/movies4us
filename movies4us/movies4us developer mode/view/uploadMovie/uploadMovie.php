...
<body>
	<center>
		...
		<div id="uploadForm">
			<form method="POST" action="../../index.php?action=publishMovie">
				
				<h2>Movie Title:</h2>
				<input id="publishFormBoxes" type="text" name="movieTitle" placeholder="Enter Your Movie Title...">
				<br>
				
				<h2>Movie Poster:</h2>
				<input id="publishFormBoxes" type="text" name="moviePoster" placeholder="Enter Your Movie Poster Link...">
				<br>
				
				<h2>Movie Link:</h2>
				<input id="publishFormBoxes" type="text" name="movieLink" placeholder="Enter Your Movie Link...">
				<br>

				<h2>Movie Description:</h2>
				<input id="publishFormDescBoxes" type="text" name="movieDescription" placeholder="Enter Your Movie Description...">
				<br>
